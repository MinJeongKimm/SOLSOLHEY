...
public class FriendStatsResponse {
    ...
    private Integer totalFriends;      // 총 친구 수
    private Integer mutualFriends;     // 상호 친구 수
    private Integer todayInteractions; // 오늘 상호작용 수
    private Integer totalInteractions; // 총 상호작용 수
    private Integer likesReceived;     // 받은 좋아요 수
    private Integer visitsReceived;    // 받은 방문 수
    private Integer cheersReceived;    // 받은 응원 수
    private Integer pointsEarnedFromFriends; // 친구 상호작용으로 얻은 포인트
