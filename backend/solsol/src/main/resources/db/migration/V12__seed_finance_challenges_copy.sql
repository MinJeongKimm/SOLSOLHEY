-- Seed FINANCE challenges (prod-safe copy of V5)
-- This duplicates V5__seed_finance_challenges.sql so that environments
-- where schema version already passed V5 can still receive these seeds
-- without enabling out-of-order. Queries are idempotent.
