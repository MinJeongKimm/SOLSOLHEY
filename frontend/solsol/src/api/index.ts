...
export async function getChallenges(category?: string): Promise<Challenge[]> {
  ...
  const dummyChallenges: Challenge[] = [
    ...
    {
      challengeId: 1,
      challengeName: "매일 독서하기",
      description: "하루 30분씩 책을 읽어보세요. 지식과 상상력을 키울 수 있습니다.",
      rewardPoints: 100,
      rewardExp: 0,
      challengeType: "일일",
      difficulty: "EASY",
      categoryName: "STUDY",
      categoryDisplayName: "학습",
      targetCount: 1,
      isActive: true,
      isAvailable: true,
      isJoined: false,
    ...
    {
      challengeId: 2,
      challengeName: "주간 학습 계획 세우기",
      description: "매주 월요일에 이번 주 학습 목표를 설정하고 계획을 세워보세요.",
      rewardPoints: 300,
      rewardExp: 0,
      challengeType: "주간",
      difficulty: "MEDIUM",
    ...
    {
      challengeId: 3,
      challengeName: "온라인 강의 완강하기",
      description: "선택한 온라인 강의를 끝까지 완강해보세요. 지속적인 학습이 성공의 열쇠입니다.",
      rewardPoints: 0,
      rewardExp: 500,
      challengeType: "월간",
      difficulty: "HARD",
    ...
    {
      challengeId: 4,
      challengeName: "외국어 단어 100개 암기",
      description: "새로운 언어를 배우며 매일 10개씩 단어를 외워보세요.",
      rewardPoints: 0,
      rewardExp: 200,
      challengeType: "특별",
      difficulty: "MEDIUM",
    ...
    {
      challengeId: 5,
      challengeName: "매일 가계부 작성하기",
      description: "소비 내역을 기록하고 지출을 관리해보세요. 절약 습관을 기를 수 있습니다.",
      rewardPoints: 150,
      rewardExp: 0,
      challengeType: "일일",
      difficulty: "EASY",
      categoryName: "FINANCE",
      categoryDisplayName: "금융",
      targetCount: 1,
      isActive: true,
      isAvailable: true,
      isJoined: false,
    ...
    {
      challengeId: 6,
      challengeName: "적금 가입하기",
      description: "신한은행에서 적금 상품을 선택하고 가입해보세요. 안전한 저축 습관을 기를 수 있습니다.",
      rewardPoints: 1000,
      rewardExp: 0,
      challengeType: "주간",
      difficulty: "MEDIUM",
    ...
    {
      challengeId: 7,
      challengeName: "투자 교육 수강하기",
      description: "금융 지식을 쌓고 투자에 대한 이해를 높여보세요.",
      rewardPoints: 0,
      rewardExp: 300,
      challengeType: "월간",
      difficulty: "HARD",
    ...
    {
      challengeId: 8,
      challengeName: "sol 페이로 결제하기",
      description: "신한 sol 페이를 사용해서 온라인 또는 오프라인에서 결제를 진행해보세요.",
      rewardPoints: 200,
      rewardExp: 0,
      challengeType: "일일",
      difficulty: "EASY",
    ...
    {
      challengeId: 9,
      challengeName: "매일 운동하기",
      description: "하루 30분씩 운동을 해보세요. 건강한 몸과 마음을 만들 수 있습니다.",
      rewardPoints: 120,
      rewardExp: 0,
      challengeType: "일일",
      difficulty: "MEDIUM",
      categoryName: "LIFESTYLE",
      categoryDisplayName: "라이프스타일",
      targetCount: 1,
      isActive: true,
      isAvailable: true,
      isJoined: false,
    ...
    {
      challengeId: 10,
      challengeName: "건강한 식단 유지하기",
      description: "일주일 동안 균형 잡힌 식사를 해보세요. 영양소를 고려한 식단을 계획해보세요.",
      rewardPoints: 400,
      rewardExp: 0,
      challengeType: "주간",
      difficulty: "MEDIUM",
    ...
    {
      challengeId: 11,
      challengeName: "취미 활동 시작하기",
      description: "새로운 취미를 시작하고 한 달 동안 꾸준히 해보세요.",
      rewardPoints: 0,
      rewardExp: 400,
      challengeType: "월간",
      difficulty: "HARD",
    ...
    {
      challengeId: 12,
      challengeName: "정리정돈 습관 만들기",
      description: "매일 10분씩 주변을 정리하고 깔끔한 환경을 유지해보세요.",
      rewardPoints: 80,
      rewardExp: 0,
      challengeType: "일일",
      difficulty: "EASY",
    ...
    {
      challengeId: 13,
      challengeName: "친구 초대하기",
      description: "친구에게 앱을 추천하고 초대 링크를 공유해보세요.",
      rewardPoints: 500,
      rewardExp: 0,
      challengeType: "특별",
      difficulty: "EASY",
    ...
    {
      challengeId: 14,
      challengeName: "도서관 출석하기",
      description: "도서관에 방문하여 체크인을 하거나 사진을 찍어 인증해보세요.",
      rewardPoints: 150,
      rewardExp: 0,
      challengeType: "일일",
      difficulty: "EASY",
    ...
    {
      challengeId: 15,
      challengeName: "봉사활동 참여하기",
      description: "지역사회 봉사활동에 참여하고 따뜻한 마음을 나누어보세요.",
      rewardPoints: 0,
      rewardExp: 600,
      challengeType: "월간",
      difficulty: "HARD",
    ...
    {
      challengeId: 16,
      challengeName: "환경보호 실천하기",
      description: "일주일 동안 플라스틱 사용을 줄이고 분리수거를 철저히 해보세요.",
      rewardPoints: 300,
      rewardExp: 0,
      challengeType: "주간",
      difficulty: "MEDIUM",
  ...
  if (category && category !== 'all') {
    return dummyChallenges.filter(challenge => challenge.categoryName === category);
  }
